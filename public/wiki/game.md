...
На главной базе игрокам доступен выбор китов
Всего может быть 1 человек с уникальным китом, кроме **стрелка**. **Стрелков** может быть бесконечное количество на команду
